    ...
    <section className="section reveal" id="bio">
      ...
      <div className="bio">
        ...
        <div className="bio__letter">
          ...
          <p>Se grabó por partes. Con amigos. Con la persona más importante de mi vida. A solas. En una habitación pequeña. Con el equipo que solia fallar. La mayoría de las composiciones son a una única toma. Hay ruidos de fondo que no me atreví a borrar; hay versos que se perdieron por el camino; hay, también, alguna línea escrita por una máquina —a estas alturas, el silencio acepta cualquier mensajero.</p>
